        ...
        <form action="connect.php" method="post">
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="lastName" name="last" class="form-control" placeholder="Last name" required="required">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" id="confirmPassword"  name="Repassword" class="form-control" placeholder="Confirm password" required="required">
