  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            ...
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Restaurant Booking Request</div>
              </div>
        ...
        <?php 
          $statement = $pdo->prepare("SELECT * FROM `food_reservation`");
          $statement->execute();
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php foreach ($clients as $client): ?>
                    ...
                    <td><?php echo $client['restaurant'] ?></td>
                    <td><?php echo $client['person'] ?></td>
                    <td><?php echo $client['bookingDate'] ?></td>
                    <td><?php echo $client['bookingTime'] ?></td>
