...
<head>
  ...
  <title>SylGuide  | Admin Panel</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">SylGuide | Admin Panel</a>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <?php 
          $statement = $pdo->prepare("SELECT * FROM `hotel_reservation`");
          $statement->execute();
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php foreach ($clients as $client): ?>
                    ...
                    <td><?php echo $client['hotel'] ?></td>
                    <td><?php echo $client['roomType'] ?></td>
                    <td><?php echo $client['rooms'] ?></td>
                    <td><?php echo $client['datein'] ?></td>
                    <td><?php echo $client['dateout'] ?></td>
                    <td><?php echo $client['adults'] ?></td>
                    <td><?php echo $client['children'] ?></td>
                  </tr>
                  <?php endforeach ?>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © SylGuide 2019</span>
          </div>
        </div>
      </footer>
