...
<head>
  <!-- Required meta tags -->
    ...
    <title>SylGuide | Hotel Garden In</title>
</head>
<body>
  <header id="header">   
    <div class="container">
		...
		<ol class="carousel-indicators">
	  	...
	  	<div class="carousel-inner">
		    <div class="carousel-item active">
		      <img class="d-block" src="images/HGI_deluxequeen.jpg" alt="First slide" width="700" height="500">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block" src="images/HGI_deluxedouble.jpg" alt="Second slide" width="700" height="500">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block" src="images/HGI_deluxefamily.jpg" alt="Third slide" width="700" height="500">
		    </div>
	  	</div>
...
<div id="fh5co-hotel-section">
	<div class="container">
		<h1 class="text-center SectionHeader pb-2 mb-4">Hotel Garden Inn</h1>
		<div class="row">
				...
				<div class="hotel-content">
					<div class="hotel-grid" style="background-image: url(images/HGI_standardsingleroom.jpg);">
	  				...
	  				<div class="desc">
					   ...
					   <p>This single room features air conditioning, minibar and cable TV.</iframe></p>
					</div>
	 			</div>
	 		</div>
			...
			<div class="col-md-4">
				<div class="hotel-content">
    				...
    				<div class="desc">
						...
						<p> This deluxe family room features air conditioning, minibar and cable TV.</p>
	  				</div>
  				</div>
			</div>
			...
			<div class="col-md-4">
   				<div class="hotel-content">
  					...
  					<div class="desc">
						...
						<p>This suit is furnished with sitting area, air conditioning, minibar and cable TV.</iframe></p>
					</div>
	  			</div>
		 	</div>
		 	...
		 	<div class="col-md-4">
				<div class="hotel-content">
					...
					<div class="desc">
						<h3>Apartment</h3>
						<p>This double room features a minibar and air conditioning</iframe></p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="hotel-content">
					...
					<div class="desc">
						...
						<p>This double room features air conditioning and minibar</iframe></p>
					</div>
				</div>
			</div>
